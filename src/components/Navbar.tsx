...
import { Menu, X, Terminal, Code, Cpu, Mail, User, Download, Briefcase } from 'lucide-react';
            ...
            <div className="container mx-auto px-6 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <a
                        ...
                        className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-blue-600 transition-colors shadow-lg shadow-blue-500/30"
                    >
                        Hire Me
                    </a>
                </div>

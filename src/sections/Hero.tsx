            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a
                            href="#projects"
                            className="px-8 py-3 bg-primary text-white rounded-lg font-medium hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/30 flex items-center gap-2"
                        >
                            View DevOps Work <ArrowRight size={18} />
                        </a>
                        <a
                            href="#ricing"
                            className="px-8 py-3 bg-white text-secondary border border-gray-200 rounded-lg font-medium hover:bg-gray-50 transition-all flex items-center gap-2"
                        >
                            <Terminal size={18} /> View Ricing
                        </a>
                    </div>
                </motion.div>
